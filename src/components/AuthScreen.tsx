...
export function AuthScreen() {
  ...
  useEffect(() => {
    ...
    if (inviteCode) {
      // Store invite code for post-auth processing
      localStorage.setItem('pendingInvite', inviteCode)
      // Remove invite param from URL for cleaner experience
      window.history.replaceState({}, document.title, window.location.pathname)
      toast.success('Invite code detected! Sign in to join the community.')
    }
  }, [])
  ...
  const handleAccessRequestSuccess = () => {
    ...
    toast.success('Access request submitted! You\'ll be notified when it\'s reviewed.')
  }
  ...
  // If showing access request form
      ...
      >
        ...
        <div className="mb-8">
          <motion.button
            ...
            className="w-full bg-gradient-to-r from-orange-500 to-orange-600 text-white py-4 rounded-xl font-semibold shadow-lg hover:shadow-xl transition-all duration-200 flex items-center justify-center gap-3"
          >
