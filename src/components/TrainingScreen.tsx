...
export function TrainingScreen() {
  ...
  return (
    <div className="h-full flex flex-col">
      {/* Fixed Header */}
      <div className="bg-bg-primary border-b border-border-primary p-3 lg:p-6 flex-shrink-0">
        <div className="max-w-4xl lg:mx-auto">
          <div className="flex items-center justify-between mb-2 lg:mb-4">
            <div className="flex items-center gap-2">
              <Trophy className="w-6 h-6 lg:w-8 lg:h-8 text-primary-600" />
              <h1 className="text-xl lg:text-4xl font-bold font-heading text-text-primary">
                {currentView === 'training' ? 'Training' : 'Leaderboard'}
              </h1>
            </div>
            ...
            <div className="flex bg-bg-tertiary rounded-lg p-1">
              <button
                ...
                className={`px-2 lg:px-3 py-1 lg:py-2 rounded-md text-xs lg:text-sm font-medium font-body transition-colors ${
